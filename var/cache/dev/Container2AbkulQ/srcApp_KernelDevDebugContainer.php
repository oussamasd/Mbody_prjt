...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.errored..service_locator..NgrknO.App\Entity\Abonnement' shared service.
     *
     * @return \App\Entity\Abonnement
     */
    protected function getAbonnementService()
    {
        $this->throw('Cannot autowire service ".service_locator..NgrknO": it references class "App\\Entity\\Abonnement" but no such service exists.');
    }
    ...
    /**
     * Gets the private '.service_locator..NgrknO' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator__NgrknOService()
    {
        return $this->privates['.service_locator..NgrknO'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'AbonnementRepository' => ['privates', 'App\\Repository\\AbonnementRepository', 'getAbonnementRepositoryService', false],
            'abonnement' => ['privates', '.errored..service_locator..NgrknO.App\\Entity\\Abonnement', NULL, 'Cannot autowire service ".service_locator..NgrknO": it references class "App\\Entity\\Abonnement" but no such service exists.'],
        ], [
    ...
    /**
     * Gets the private '.service_locator.Cvs2nTA' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Cvs2nTAService()
    {
        return $this->privates['.service_locator.Cvs2nTA'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\AbonnementController::Liste' => ['privates', '.service_locator..NgrknO', 'get_ServiceLocator__NgrknOService', false],
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder9ab3d = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer90975 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties91c55 = [
        
    ];

    public function getConnection()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'getConnection', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'getMetadataFactory', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'getExpressionBuilder', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'beginTransaction', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'getCache', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->getCache();
    }

    public function transactional($func)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'transactional', array('func' => $func), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'wrapInTransaction', array('func' => $func), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'commit', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->commit();
    }

    public function rollback()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'rollback', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'getClassMetadata', array('className' => $className), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'createQuery', array('dql' => $dql), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'createNamedQuery', array('name' => $name), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'createQueryBuilder', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'flush', array('entity' => $entity), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'clear', array('entityName' => $entityName), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->clear($entityName);
    }

    public function close()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'close', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->close();
    }

    public function persist($entity)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'persist', array('entity' => $entity), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'remove', array('entity' => $entity), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'refresh', array('entity' => $entity), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'detach', array('entity' => $entity), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'merge', array('entity' => $entity), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'getRepository', array('entityName' => $entityName), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'contains', array('entity' => $entity), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'getEventManager', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'getConfiguration', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'isOpen', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'getUnitOfWork', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'getProxyFactory', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'initializeObject', array('obj' => $obj), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'getFilters', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'isFiltersStateClean', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'hasFilters', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return $this->valueHolder9ab3d->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer90975 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder9ab3d) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder9ab3d = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder9ab3d->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, '__get', ['name' => $name], $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        if (isset(self::$publicProperties91c55[$name])) {
            return $this->valueHolder9ab3d->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder9ab3d;
    ...
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;
    ...
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, '__isset', array('name' => $name), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;
    ...
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, '__unset', array('name' => $name), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;
    ...
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, '__clone', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        $this->valueHolder9ab3d = clone $this->valueHolder9ab3d;
    }

    public function __sleep()
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, '__sleep', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        return array('valueHolder9ab3d');
    }
    ...
    {
        $this->initializer90975 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer90975;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'initializeProxy', array(), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder9ab3d;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder9ab3d;
    }
}
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer90975 && ($this->initializer90975->__invoke($valueHolder9ab3d, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer90975) || 1) && $this->valueHolder9ab3d = $valueHolder9ab3d;

        if ($this->valueHolder9ab3d === $returnValue = $this->valueHolder9ab3d->paginate($target, $page, $limit, $options)) {
            return $this;
        }
