...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder0fdc9 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer2476f = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties9ab0b = [
        
    ];

    public function getConnection()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'getConnection', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'getMetadataFactory', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'getExpressionBuilder', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'beginTransaction', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'getCache', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->getCache();
    }

    public function transactional($func)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'transactional', array('func' => $func), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'wrapInTransaction', array('func' => $func), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'commit', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->commit();
    }

    public function rollback()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'rollback', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'getClassMetadata', array('className' => $className), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'createQuery', array('dql' => $dql), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'createNamedQuery', array('name' => $name), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'createQueryBuilder', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'flush', array('entity' => $entity), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'clear', array('entityName' => $entityName), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->clear($entityName);
    }

    public function close()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'close', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->close();
    }

    public function persist($entity)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'persist', array('entity' => $entity), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'remove', array('entity' => $entity), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'refresh', array('entity' => $entity), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'detach', array('entity' => $entity), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'merge', array('entity' => $entity), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'getRepository', array('entityName' => $entityName), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'contains', array('entity' => $entity), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'getEventManager', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'getConfiguration', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'isOpen', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'getUnitOfWork', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'getProxyFactory', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'initializeObject', array('obj' => $obj), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'getFilters', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'isFiltersStateClean', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'hasFilters', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return $this->valueHolder0fdc9->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer2476f = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder0fdc9) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder0fdc9 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder0fdc9->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, '__get', ['name' => $name], $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        if (isset(self::$publicProperties9ab0b[$name])) {
            return $this->valueHolder0fdc9->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder0fdc9;
    ...
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;
    ...
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, '__isset', array('name' => $name), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;
    ...
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, '__unset', array('name' => $name), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;
    ...
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, '__clone', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        $this->valueHolder0fdc9 = clone $this->valueHolder0fdc9;
    }

    public function __sleep()
    {
        $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, '__sleep', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;

        return array('valueHolder0fdc9');
    }
    ...
    {
        $this->initializer2476f = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer2476f;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer2476f && ($this->initializer2476f->__invoke($valueHolder0fdc9, $this, 'initializeProxy', array(), $this->initializer2476f) || 1) && $this->valueHolder0fdc9 = $valueHolder0fdc9;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder0fdc9;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder0fdc9;
    }
}
