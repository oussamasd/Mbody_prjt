...
return [
    ...
    'entreneur_index' => [[], ['_controller' => 'App\\Controller\\EntreneurController::index'], [], [['text', '/entreneur/']], [], []],
    'entreneur_new' => [[], ['_controller' => 'App\\Controller\\EntreneurController::new'], [], [['text', '/entreneur/new']], [], []],
    'entreneur_show' => [['id'], ['_controller' => 'App\\Controller\\EntreneurController::show'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/entreneur']], [], []],
    'entreneur_edit' => [['id'], ['_controller' => 'App\\Controller\\EntreneurController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id'], ['text', '/entreneur']], [], []],
    'entreneur_delete' => [['id'], ['_controller' => 'App\\Controller\\EntreneurController::delete'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/entreneur']], [], []],
];
