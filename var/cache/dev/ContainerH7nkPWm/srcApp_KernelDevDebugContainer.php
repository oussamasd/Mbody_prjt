...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.X9.eFJ2' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_X9_EFJ2Service()
    {
        return $this->privates['.service_locator.X9.eFJ2'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHoldercf96b = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer25d9a = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties0f304 = [
        
    ];

    public function getConnection()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'getConnection', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'getMetadataFactory', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'getExpressionBuilder', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'beginTransaction', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'getCache', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->getCache();
    }

    public function transactional($func)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'transactional', array('func' => $func), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'wrapInTransaction', array('func' => $func), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'commit', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->commit();
    }

    public function rollback()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'rollback', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'getClassMetadata', array('className' => $className), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'createQuery', array('dql' => $dql), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'createNamedQuery', array('name' => $name), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'createQueryBuilder', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'flush', array('entity' => $entity), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'clear', array('entityName' => $entityName), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->clear($entityName);
    }

    public function close()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'close', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->close();
    }

    public function persist($entity)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'persist', array('entity' => $entity), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'remove', array('entity' => $entity), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'refresh', array('entity' => $entity), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'detach', array('entity' => $entity), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'merge', array('entity' => $entity), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'getRepository', array('entityName' => $entityName), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'contains', array('entity' => $entity), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'getEventManager', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'getConfiguration', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'isOpen', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'getUnitOfWork', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'getProxyFactory', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'initializeObject', array('obj' => $obj), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'getFilters', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'isFiltersStateClean', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'hasFilters', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return $this->valueHoldercf96b->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer25d9a = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHoldercf96b) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHoldercf96b = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHoldercf96b->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, '__get', ['name' => $name], $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        if (isset(self::$publicProperties0f304[$name])) {
            return $this->valueHoldercf96b->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHoldercf96b;
    ...
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;
    ...
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, '__isset', array('name' => $name), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;
    ...
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, '__unset', array('name' => $name), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;
    ...
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, '__clone', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        $this->valueHoldercf96b = clone $this->valueHoldercf96b;
    }

    public function __sleep()
    {
        $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, '__sleep', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;

        return array('valueHoldercf96b');
    }
    ...
    {
        $this->initializer25d9a = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer25d9a;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer25d9a && ($this->initializer25d9a->__invoke($valueHoldercf96b, $this, 'initializeProxy', array(), $this->initializer25d9a) || 1) && $this->valueHoldercf96b = $valueHoldercf96b;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHoldercf96b;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHoldercf96b;
    }
}
