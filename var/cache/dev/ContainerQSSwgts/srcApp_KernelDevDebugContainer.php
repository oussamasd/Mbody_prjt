...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('kqjBgnnoKC', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ss0dptdDK5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SgE7OOtCpa', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TJq6Qgo11y', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('a6gmtyeAp5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('U4ykc2nIa9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ie0bPAM85e', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder948e1 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializere0900 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties0dfa6 = [
        
    ];

    public function getConnection()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'getConnection', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'getMetadataFactory', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'getExpressionBuilder', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'beginTransaction', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->beginTransaction();
    }

    public function getCache()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'getCache', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->getCache();
    }

    public function transactional($func)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'transactional', array('func' => $func), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'wrapInTransaction', array('func' => $func), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'commit', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->commit();
    }

    public function rollback()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'rollback', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'getClassMetadata', array('className' => $className), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'createQuery', array('dql' => $dql), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'createNamedQuery', array('name' => $name), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'createQueryBuilder', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'flush', array('entity' => $entity), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'clear', array('entityName' => $entityName), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->clear($entityName);
    }

    public function close()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'close', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->close();
    }

    public function persist($entity)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'persist', array('entity' => $entity), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'remove', array('entity' => $entity), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'refresh', array('entity' => $entity), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'detach', array('entity' => $entity), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'merge', array('entity' => $entity), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'getRepository', array('entityName' => $entityName), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'contains', array('entity' => $entity), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'getEventManager', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'getConfiguration', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'isOpen', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'getUnitOfWork', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'getProxyFactory', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'initializeObject', array('obj' => $obj), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'getFilters', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'isFiltersStateClean', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'hasFilters', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return $this->valueHolder948e1->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializere0900 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder948e1) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder948e1 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder948e1->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, '__get', ['name' => $name], $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        if (isset(self::$publicProperties0dfa6[$name])) {
            return $this->valueHolder948e1->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder948e1;
    ...
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, '__set', array('name' => $name, 'value' => $value), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;
    ...
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, '__isset', array('name' => $name), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;
    ...
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, '__unset', array('name' => $name), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;
    ...
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, '__clone', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        $this->valueHolder948e1 = clone $this->valueHolder948e1;
    }

    public function __sleep()
    {
        $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, '__sleep', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;

        return array('valueHolder948e1');
    }
    ...
    {
        $this->initializere0900 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializere0900;
    }

    public function initializeProxy() : bool
    {
        return $this->initializere0900 && ($this->initializere0900->__invoke($valueHolder948e1, $this, 'initializeProxy', array(), $this->initializere0900) || 1) && $this->valueHolder948e1 = $valueHolder948e1;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder948e1;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder948e1;
    }
}
