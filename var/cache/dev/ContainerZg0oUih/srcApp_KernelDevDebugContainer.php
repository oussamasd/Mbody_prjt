...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.XodAc_b' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_XodAcBService()
    {
        return $this->privates['.service_locator.XodAc_b'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\ActivityController::index' => ['privates', '.service_locator.n8gOTNr', 'get_ServiceLocator_N8gOTNrService', false],
            'App\\Controller\\ActivityController::index3' => ['privates', '.service_locator.n8gOTNr', 'get_ServiceLocator_N8gOTNrService', false],
            ...
            'App\\Controller\\ActivityController::index3' => '?',
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder91957 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerf165b = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties07ef5 = [
        
    ];

    public function getConnection()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'getConnection', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'getMetadataFactory', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'getExpressionBuilder', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'beginTransaction', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'getCache', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->getCache();
    }

    public function transactional($func)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'transactional', array('func' => $func), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'wrapInTransaction', array('func' => $func), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'commit', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->commit();
    }

    public function rollback()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'rollback', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'getClassMetadata', array('className' => $className), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'createQuery', array('dql' => $dql), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'createNamedQuery', array('name' => $name), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'createQueryBuilder', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'flush', array('entity' => $entity), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'clear', array('entityName' => $entityName), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->clear($entityName);
    }

    public function close()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'close', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->close();
    }

    public function persist($entity)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'persist', array('entity' => $entity), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'remove', array('entity' => $entity), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'refresh', array('entity' => $entity), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'detach', array('entity' => $entity), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'merge', array('entity' => $entity), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'getRepository', array('entityName' => $entityName), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'contains', array('entity' => $entity), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'getEventManager', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'getConfiguration', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'isOpen', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'getUnitOfWork', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'getProxyFactory', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'initializeObject', array('obj' => $obj), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'getFilters', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'isFiltersStateClean', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'hasFilters', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return $this->valueHolder91957->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerf165b = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder91957) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder91957 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder91957->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, '__get', ['name' => $name], $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        if (isset(self::$publicProperties07ef5[$name])) {
            return $this->valueHolder91957->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder91957;
    ...
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;
    ...
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, '__isset', array('name' => $name), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;
    ...
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, '__unset', array('name' => $name), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;
    ...
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, '__clone', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        $this->valueHolder91957 = clone $this->valueHolder91957;
    }

    public function __sleep()
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, '__sleep', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        return array('valueHolder91957');
    }
    ...
    {
        $this->initializerf165b = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerf165b;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'initializeProxy', array(), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder91957;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder91957;
    }
}
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializerf165b && ($this->initializerf165b->__invoke($valueHolder91957, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializerf165b) || 1) && $this->valueHolder91957 = $valueHolder91957;

        if ($this->valueHolder91957 === $returnValue = $this->valueHolder91957->paginate($target, $page, $limit, $options)) {
            return $this;
        }
