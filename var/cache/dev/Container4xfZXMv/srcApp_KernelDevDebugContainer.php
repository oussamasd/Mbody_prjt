...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.7ibQdA1' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_7ibQdA1Service()
    {
        return $this->privates['.service_locator.7ibQdA1'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\AbonnementController::Liste' => ['privates', '.service_locator.5G5NXiw', 'get_ServiceLocator_5G5NXiwService', false],
            'App\\Controller\\AbonnementController::afficher' => ['privates', '.service_locator.g3TY9AI', 'get_ServiceLocator_G3TY9AIService', false],
            ...
            'App\\Controller\\AbonnementController::triname' => ['privates', '.service_locator.3suOlCd', 'get_ServiceLocator_3suOlCdService', false],
            ...
            'App\\Controller\\OffreController::new' => ['privates', '.service_locator.x8FmIZ0', 'get_ServiceLocator_X8FmIZ0Service', false],
            ...
            'App\\Controller\\AbonnementController::triname' => '?',
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.7ibQdA1'] ?? $this->get_ServiceLocator_7ibQdA1Service())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder6a862 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerde297 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties03d0e = [
        
    ];

    public function getConnection()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'getConnection', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'getMetadataFactory', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'getExpressionBuilder', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'beginTransaction', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'getCache', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->getCache();
    }

    public function transactional($func)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'transactional', array('func' => $func), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'wrapInTransaction', array('func' => $func), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'commit', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->commit();
    }

    public function rollback()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'rollback', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'getClassMetadata', array('className' => $className), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'createQuery', array('dql' => $dql), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'createNamedQuery', array('name' => $name), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'createQueryBuilder', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'flush', array('entity' => $entity), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'clear', array('entityName' => $entityName), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->clear($entityName);
    }

    public function close()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'close', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->close();
    }

    public function persist($entity)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'persist', array('entity' => $entity), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'remove', array('entity' => $entity), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'refresh', array('entity' => $entity), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'detach', array('entity' => $entity), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'merge', array('entity' => $entity), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'getRepository', array('entityName' => $entityName), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'contains', array('entity' => $entity), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'getEventManager', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'getConfiguration', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'isOpen', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'getUnitOfWork', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'getProxyFactory', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'initializeObject', array('obj' => $obj), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'getFilters', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'isFiltersStateClean', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'hasFilters', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return $this->valueHolder6a862->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerde297 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder6a862) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder6a862 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder6a862->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, '__get', ['name' => $name], $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        if (isset(self::$publicProperties03d0e[$name])) {
            return $this->valueHolder6a862->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder6a862;
    ...
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;
    ...
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, '__isset', array('name' => $name), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;
    ...
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, '__unset', array('name' => $name), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;
    ...
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, '__clone', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        $this->valueHolder6a862 = clone $this->valueHolder6a862;
    }

    public function __sleep()
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, '__sleep', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        return array('valueHolder6a862');
    }
    ...
    {
        $this->initializerde297 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerde297;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'initializeProxy', array(), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder6a862;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder6a862;
    }
}
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializerde297 && ($this->initializerde297->__invoke($valueHolder6a862, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializerde297) || 1) && $this->valueHolder6a862 = $valueHolder6a862;

        if ($this->valueHolder6a862 === $returnValue = $this->valueHolder6a862->paginate($target, $page, $limit, $options)) {
            return $this;
        }
