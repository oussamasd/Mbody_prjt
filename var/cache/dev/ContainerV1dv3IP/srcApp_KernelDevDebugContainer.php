...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.inYCicJ' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_InYCicJService()
    {
        return $this->privates['.service_locator.inYCicJ'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.inYCicJ'] ?? $this->get_ServiceLocator_InYCicJService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder3901d = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer483db = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesc471e = [
        
    ];

    public function getConnection()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'getConnection', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'getMetadataFactory', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'getExpressionBuilder', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'beginTransaction', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'getCache', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->getCache();
    }

    public function transactional($func)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'transactional', array('func' => $func), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'wrapInTransaction', array('func' => $func), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'commit', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->commit();
    }

    public function rollback()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'rollback', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'getClassMetadata', array('className' => $className), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'createQuery', array('dql' => $dql), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'createNamedQuery', array('name' => $name), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'createQueryBuilder', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'flush', array('entity' => $entity), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'clear', array('entityName' => $entityName), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->clear($entityName);
    }

    public function close()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'close', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->close();
    }

    public function persist($entity)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'persist', array('entity' => $entity), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'remove', array('entity' => $entity), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'refresh', array('entity' => $entity), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'detach', array('entity' => $entity), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'merge', array('entity' => $entity), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'getRepository', array('entityName' => $entityName), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'contains', array('entity' => $entity), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'getEventManager', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'getConfiguration', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'isOpen', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'getUnitOfWork', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'getProxyFactory', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'initializeObject', array('obj' => $obj), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'getFilters', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'isFiltersStateClean', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'hasFilters', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return $this->valueHolder3901d->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer483db = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder3901d) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder3901d = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder3901d->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, '__get', ['name' => $name], $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        if (isset(self::$publicPropertiesc471e[$name])) {
            return $this->valueHolder3901d->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder3901d;
    ...
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;
    ...
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, '__isset', array('name' => $name), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;
    ...
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, '__unset', array('name' => $name), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;
    ...
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, '__clone', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        $this->valueHolder3901d = clone $this->valueHolder3901d;
    }

    public function __sleep()
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, '__sleep', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        return array('valueHolder3901d');
    }
    ...
    {
        $this->initializer483db = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer483db;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'initializeProxy', array(), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder3901d;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder3901d;
    }
}
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer483db && ($this->initializer483db->__invoke($valueHolder3901d, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer483db) || 1) && $this->valueHolder3901d = $valueHolder3901d;

        if ($this->valueHolder3901d === $returnValue = $this->valueHolder3901d->paginate($target, $page, $limit, $options)) {
            return $this;
        }
