...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.aXv8UbQ' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_AXv8UbQService()
    {
        return $this->privates['.service_locator.aXv8UbQ'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'AbonnementRepository' => ['privates', 'App\\Repository\\AbonnementRepository', 'getAbonnementRepositoryService', false],
        ], [
            'AbonnementRepository' => 'App\\Repository\\AbonnementRepository',
        ]);
    ...
    /**
     * Gets the private '.service_locator.abohUXh' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_AbohUXhService()
    {
        return $this->privates['.service_locator.abohUXh'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\AbonnementController::Liste' => ['privates', '.service_locator.aXv8UbQ', 'get_ServiceLocator_AXv8UbQService', false],
            ...
            'App\\Controller\\OffreController::Liste' => ['privates', '.service_locator.Jh7UbNl', 'get_ServiceLocator_Jh7UbNlService', false],
            ...
            'App\\Controller\\OffreController::Liste' => '?',
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.abohUXh'] ?? $this->get_ServiceLocator_AbohUXhService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder25baa = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerceac5 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties480b1 = [
        
    ];

    public function getConnection()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'getConnection', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'getMetadataFactory', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'getExpressionBuilder', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'beginTransaction', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'getCache', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->getCache();
    }

    public function transactional($func)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'transactional', array('func' => $func), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'wrapInTransaction', array('func' => $func), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'commit', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->commit();
    }

    public function rollback()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'rollback', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'getClassMetadata', array('className' => $className), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'createQuery', array('dql' => $dql), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'createNamedQuery', array('name' => $name), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'createQueryBuilder', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'flush', array('entity' => $entity), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'clear', array('entityName' => $entityName), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->clear($entityName);
    }

    public function close()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'close', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->close();
    }

    public function persist($entity)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'persist', array('entity' => $entity), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'remove', array('entity' => $entity), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'refresh', array('entity' => $entity), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'detach', array('entity' => $entity), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'merge', array('entity' => $entity), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'getRepository', array('entityName' => $entityName), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'contains', array('entity' => $entity), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'getEventManager', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'getConfiguration', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'isOpen', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'getUnitOfWork', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'getProxyFactory', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'initializeObject', array('obj' => $obj), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'getFilters', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'isFiltersStateClean', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'hasFilters', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return $this->valueHolder25baa->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerceac5 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder25baa) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder25baa = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder25baa->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, '__get', ['name' => $name], $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        if (isset(self::$publicProperties480b1[$name])) {
            return $this->valueHolder25baa->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder25baa;
    ...
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;
    ...
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, '__isset', array('name' => $name), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;
    ...
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, '__unset', array('name' => $name), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;
    ...
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, '__clone', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        $this->valueHolder25baa = clone $this->valueHolder25baa;
    }

    public function __sleep()
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, '__sleep', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        return array('valueHolder25baa');
    }
    ...
    {
        $this->initializerceac5 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerceac5;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'initializeProxy', array(), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder25baa;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder25baa;
    }
}
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializerceac5 && ($this->initializerceac5->__invoke($valueHolder25baa, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializerceac5) || 1) && $this->valueHolder25baa = $valueHolder25baa;

        if ($this->valueHolder25baa === $returnValue = $this->valueHolder25baa->paginate($target, $page, $limit, $options)) {
            return $this;
        }
