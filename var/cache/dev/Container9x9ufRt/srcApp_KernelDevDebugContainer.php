...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder7c47f = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer68438 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesa0d92 = [
        
    ];

    public function getConnection()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'getConnection', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'getMetadataFactory', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'getExpressionBuilder', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'beginTransaction', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'getCache', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->getCache();
    }

    public function transactional($func)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'transactional', array('func' => $func), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'wrapInTransaction', array('func' => $func), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'commit', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->commit();
    }

    public function rollback()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'rollback', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'getClassMetadata', array('className' => $className), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'createQuery', array('dql' => $dql), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'createNamedQuery', array('name' => $name), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'createQueryBuilder', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'flush', array('entity' => $entity), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'clear', array('entityName' => $entityName), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->clear($entityName);
    }

    public function close()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'close', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->close();
    }

    public function persist($entity)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'persist', array('entity' => $entity), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'remove', array('entity' => $entity), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'refresh', array('entity' => $entity), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'detach', array('entity' => $entity), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'merge', array('entity' => $entity), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'getRepository', array('entityName' => $entityName), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'contains', array('entity' => $entity), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'getEventManager', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'getConfiguration', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'isOpen', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'getUnitOfWork', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'getProxyFactory', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'initializeObject', array('obj' => $obj), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'getFilters', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'isFiltersStateClean', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'hasFilters', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return $this->valueHolder7c47f->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer68438 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder7c47f) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder7c47f = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder7c47f->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, '__get', ['name' => $name], $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        if (isset(self::$publicPropertiesa0d92[$name])) {
            return $this->valueHolder7c47f->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder7c47f;
    ...
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;
    ...
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, '__isset', array('name' => $name), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;
    ...
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, '__unset', array('name' => $name), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;
    ...
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, '__clone', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        $this->valueHolder7c47f = clone $this->valueHolder7c47f;
    }

    public function __sleep()
    {
        $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, '__sleep', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;

        return array('valueHolder7c47f');
    }
    ...
    {
        $this->initializer68438 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer68438;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer68438 && ($this->initializer68438->__invoke($valueHolder7c47f, $this, 'initializeProxy', array(), $this->initializer68438) || 1) && $this->valueHolder7c47f = $valueHolder7c47f;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder7c47f;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder7c47f;
    }
}
