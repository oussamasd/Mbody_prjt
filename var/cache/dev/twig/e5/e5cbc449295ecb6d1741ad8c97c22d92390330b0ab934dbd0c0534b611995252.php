...
";
        // line 2
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["formCategory"]) || array_key_exists("formCategory", $context) ? $context["formCategory"] : (function () { throw new RuntimeError('Variable "formCategory" does not exist.', 2, $this->source); })()), 'form');
...
{{ form(formCategory) }}", "category/add.html.twig", "C:\\wamp64\\www\\Mbody_prjt\\templates\\category\\add.html.twig");
    }
}
