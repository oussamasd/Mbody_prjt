...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('bUn7cTjq1U', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rGiFwvStak', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    /**
     * Gets the private '.service_locator.C2wkxOx' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_C2wkxOxService()
    {
        return $this->privates['.service_locator.C2wkxOx'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('T4pHotb1bm', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('B8gaIOxBc1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rrblUsmAqB', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('s9uZcCleCA', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gwSByzV1cF', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.C2wkxOx'] ?? $this->get_ServiceLocator_C2wkxOxService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder905a2 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerd527f = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesdab33 = [
        
    ];

    public function getConnection()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'getConnection', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'getMetadataFactory', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'getExpressionBuilder', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'beginTransaction', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'getCache', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->getCache();
    }

    public function transactional($func)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'transactional', array('func' => $func), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'wrapInTransaction', array('func' => $func), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'commit', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->commit();
    }

    public function rollback()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'rollback', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'getClassMetadata', array('className' => $className), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'createQuery', array('dql' => $dql), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'createNamedQuery', array('name' => $name), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'createQueryBuilder', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'flush', array('entity' => $entity), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'clear', array('entityName' => $entityName), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->clear($entityName);
    }

    public function close()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'close', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->close();
    }

    public function persist($entity)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'persist', array('entity' => $entity), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'remove', array('entity' => $entity), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'refresh', array('entity' => $entity), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'detach', array('entity' => $entity), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'merge', array('entity' => $entity), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'getRepository', array('entityName' => $entityName), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'contains', array('entity' => $entity), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'getEventManager', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'getConfiguration', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'isOpen', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'getUnitOfWork', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'getProxyFactory', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'initializeObject', array('obj' => $obj), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'getFilters', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'isFiltersStateClean', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'hasFilters', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return $this->valueHolder905a2->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerd527f = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder905a2) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder905a2 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder905a2->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, '__get', ['name' => $name], $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        if (isset(self::$publicPropertiesdab33[$name])) {
            return $this->valueHolder905a2->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder905a2;
    ...
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;
    ...
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, '__isset', array('name' => $name), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;
    ...
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, '__unset', array('name' => $name), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;
    ...
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, '__clone', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        $this->valueHolder905a2 = clone $this->valueHolder905a2;
    }

    public function __sleep()
    {
        $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, '__sleep', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;

        return array('valueHolder905a2');
    }
    ...
    {
        $this->initializerd527f = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerd527f;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerd527f && ($this->initializerd527f->__invoke($valueHolder905a2, $this, 'initializeProxy', array(), $this->initializerd527f) || 1) && $this->valueHolder905a2 = $valueHolder905a2;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder905a2;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder905a2;
    }
}
