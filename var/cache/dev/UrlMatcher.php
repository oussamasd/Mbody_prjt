...
return [
    ...
    [ // $staticRoutes
        ...
        '/entreneur' => [[['_route' => 'entreneur_index', '_controller' => 'App\\Controller\\EntreneurController::index'], null, ['GET' => 0], null, true, false, null]],
        '/entreneur/new' => [[['_route' => 'entreneur_new', '_controller' => 'App\\Controller\\EntreneurController::new'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/_(?'
    ...
    [ // $dynamicRoutes
        ...
        243 => [[['_route' => 'entreneur_show', '_controller' => 'App\\Controller\\EntreneurController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        256 => [[['_route' => 'entreneur_edit', '_controller' => 'App\\Controller\\EntreneurController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        264 => [
            [['_route' => 'entreneur_delete', '_controller' => 'App\\Controller\\EntreneurController::delete'], ['id'], ['POST' => 0], null, false, true, null],
