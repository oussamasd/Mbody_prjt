 ...
 */
final class Version20220303011348 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rating CHANGE id_activity_id id_activity_id INT NOT NULL, CHANGE iduser_id iduser_id INT NOT NULL');
        $this->addSql('ALTER TABLE rating ADD PRIMARY KEY (id_activity_id, iduser_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rating DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE rating CHANGE id_activity_id id_activity_id INT DEFAULT NULL, CHANGE iduser_id iduser_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE rating ADD PRIMARY KEY (rate)');
