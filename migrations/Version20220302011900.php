 ...
 */
final class Version20220302011900 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rating (iduser INT NOT NULL, idactivity INT NOT NULL, rate INT NOT NULL, PRIMARY KEY(iduser, idactivity)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
