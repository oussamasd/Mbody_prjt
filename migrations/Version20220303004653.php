 ...
 */
final class Version20220303004653 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rating CHANGE iduser iduser LONGTEXT NOT NULL COMMENT \'(DC2Type:object)\', CHANGE idactivity idactivity LONGTEXT NOT NULL COMMENT \'(DC2Type:object)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rating CHANGE iduser iduser INT NOT NULL, CHANGE idactivity idactivity INT NOT NULL');
