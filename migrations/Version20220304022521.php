 ...
 */
final class Version20220304022521 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD date_com VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire DROP date_com, CHANGE iduser iduser LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:object)\', CHANGE textcommentaire textcommentaire LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
